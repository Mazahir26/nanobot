    ...
    def _parse_response(self, response: Any) -> LLMResponse:
        ...
        if hasattr(choice, "grounding_metadata") and choice.grounding_metadata:
            ...
            grounding_metadata = GroundingMetadata(
                ...
                grounding_chunks=[
                    {"uri": getattr(chunk.web, "uri", ""), "title": getattr(chunk.web, "title", "")}
                ...
                grounding_supports=[
                    {
                        "segment": {
                            "startIndex": getattr(getattr(s, "segment", None), "start_index", 0),
                            "endIndex": getattr(getattr(s, "segment", None), "end_index", 0),
                            "text": getattr(getattr(s, "segment", None), "text", ""),
                        },
                        "groundingChunkIndices": getattr(s, "grounding_chunk_indices", []),
                    }
                    for s in getattr(gm, "grounding_supports", [])
                ],
