...
""",
        "BOOTSTRAP.md": """title: "BOOTSTRAP.md Template"
...
def gateway(
    ...
    agent = AgentLoop(
        ...
        google_search=config.get_provider(config.agents.defaults.model).google_search if config.get_provider(config.agents.defaults.model) else False,
    )
